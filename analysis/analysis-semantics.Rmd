...
```
Frequency decreases across assocates, for all age groups.
...
The textblob toolkit has both polarity and subjectivity measures, so I just through them in, but there's a lot of missing data for both measures.
